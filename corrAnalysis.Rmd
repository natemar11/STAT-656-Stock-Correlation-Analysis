...
One thing we noticed is that AMD is the company that generally correlates least with the broader market. It can be predicted with its most correlated stock, Nvidia.
...
One thing we noticed was a general upward trend in correlation. In addition, we can see major events that affected all companies, such as the event from 2022 to 2023 where all companies got spikes in relative correlations. We can ignore those time frames in favor of "normal times" to get a better idea of how companies correlate in normal conditions.
...
We noticed that the tariff relief period had the lowest volatility, and covid had the highest volatility. Additionally, we noticed that during the first stage of tariff relief, AMD and Nvidia had high volatility in comparision to other companies. However, Nvidia and ASML have a similarly good correlation, while ASML has lower volatility. Therefore, it might be a good idea to try and compare Nvidia and ASML, since ASML might be more consistent, and they have a similar lag.
